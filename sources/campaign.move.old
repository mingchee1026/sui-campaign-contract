...
module campaign::campaign {
    ...
    public fun remove_referrals(_: &AdminCap, campaign: &mut Campaign, referrer: address): Table<address, bool> {
    ...
    public fun remove_referrals_update(_: &AdminCap, campaign: &mut Campaign, referrer: address) {
        // if (table::contains<address, Table<address, bool>>(&campaign.referrals, referrer)) {
        //     // Remove referee to the referees table
        //     table::remove(&mut campaign.referrals, referrer);
        // }
    ...
    public fun remove_activities_update(_: &AdminCap, campaign: &mut Campaign, referrer: address) {
        // if (table::contains<address, Table<address, bool>>(&campaign.referrals, referrer)) {
        //     // Remove referee to the referees table
        //     table::remove(&mut campaign.referrals, referrer);
        // }
    ...
    public entry fun delete_campaign(_: &AdminCap, campObject: Campaign){
        ...
        table::drop(total_referees);
        table::destroy_empty(referrals);
        table::destroy_empty(activities);
    }
